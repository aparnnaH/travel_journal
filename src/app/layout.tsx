  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-cream text-ink">
        {/* Google Tag Manager loads globally without rendering inline script text in the React tree. */}
        <Script id="google-tag-manager" src={`https://www.googletagmanager.com/gtm.js?id=${GTM_ID}`} strategy="afterInteractive" />
        <noscript>
